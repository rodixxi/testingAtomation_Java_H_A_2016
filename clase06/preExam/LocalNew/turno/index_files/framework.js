        ...
        return {
            ...
            setTinyMCE: function (textarea) {
                tinymce.init({
                    ...
                    plugins : "table link image textcolor media",
                    width: '700px',
                    height: '250px',
                    language: 'es',
                    menubar: "edit format table",
                    toolbar: "undo redo | bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist | forecolor backcolor | link image media | removeformat",
